...
def feature_extractions(filename, model):
    """
...
if __name__ == "__main__":
    ...
    max_length = max(
        [len(c.split()) for c in caption_to_list(train_caption_dict)]) - 1  # Maximum length of input sequence
...
if __name__ == "__main__":
    ...
    train_generator = generate_dataset(train_caption_dict, train_features, tokenizer, max_length, vocab_size,
                                       num_photos)
